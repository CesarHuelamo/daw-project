...
socket.on('final', (data) => { //end of the game function
    console.log(data);
    let aux = [];
    ...
    aux.sort((a,b) => { //sort users by score
            return b[1] - a[1];  
    });
    aux.map((v,i) => {
    ...
    let finalScoreTitle = document.querySelector('.finalScoreTitle').style.display = 'block';
    if(document.getElementById('finalScore')) document.querySelector('section > div').removeChild(document.getElementById('finalScore'));
